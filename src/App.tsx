...
import { signInWithPopup, GoogleAuthProvider, signOut, onAuthStateChanged, User as FirebaseUser, deleteUser } from 'firebase/auth';
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-white dark:bg-black p-6 h-full relative z-[200]">
      ...
      <div className="w-full max-w-[280px] flex flex-col gap-3">
        <button onClick={() => handleLogin(false)} disabled={loading} className="w-full bg-white text-black font-bold py-3.5 rounded-xl text-[14px] flex items-center justify-center gap-3 active:scale-95 transition-transform hover:bg-zinc-100 border border-zinc-200 disabled:opacity-70 disabled:scale-100">
        ...
        <button onClick={() => handleLogin(true)} disabled={loading} className="w-full bg-transparent text-zinc-500 font-medium py-2 rounded-xl text-[12px] hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors disabled:opacity-50">
          Having trouble? Use redirect instead
        </button>
      </div>
    </div>
  );
